...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_DEXSEARCHING_0x264 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_DEXNAV_GET_0x265 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_DETECTOR_MODE_0x266 // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_SPECIES_0x40F7 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_STEP_COUNTER_0x40F8 // Steps for finding hidden pokemon
